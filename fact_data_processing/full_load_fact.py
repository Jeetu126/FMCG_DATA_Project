...
# MAGIC %run /Workspace/Users/---@gmail.com/catalog_pipeline/catalog_setup/utilities
...
base_path = f's3://fmcg-sports-data/{data_source}'
...
# Moving file from source to processed
...
# MAGIC %md merge with parent company
